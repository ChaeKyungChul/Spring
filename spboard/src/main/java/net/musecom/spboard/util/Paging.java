...
public class Paging {
	...
	private int totalPosts; // 전체글수
	private int postsPerPage; // 한 화면에 보여줄 블럭 수
	private int pagesPerBlock; // 한화면에 보여줄 페이지 수
	...
	public String toString() {
		return "Paging [currentPage=" + currentPage + ", totalPosts=" + totalPosts + ", postPerPage=" + postsPerPage
