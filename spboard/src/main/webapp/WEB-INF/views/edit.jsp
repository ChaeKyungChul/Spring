                    ...
                    <form action="editok" name="writeform" id="writeform" class="writeform row" method="post">
                        ...
                        <div class="col-12 row">
                            <div class="col-6 row form-group">
                                ...
                                <input type="text" name="writer" value="" id="writer" class="form-control" placeholder="이름">
                            </div>
                            <div class="col-6 row form-group">
                                <label class="form-label">비밀번호</label>
                                <input type="password" name="pass" id="password" value="" class="form-control" placeholder="비밀번호">
                            </div>
                        </div>
